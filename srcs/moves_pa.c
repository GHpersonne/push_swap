...
/*   Updated: 2024/01/10 01:01:08 by anjambon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_case_rrarrb_a(t_stack *stack_a, t_stack *stack_b, int j)
{
	...
	if (ft_push_index_a(stack_a, j))
		i = ft_lstsize(stack_a) - ft_push_index_a(stack_a, j);
	if ((i < (ft_lstsize(stack_b) - ft_find_index(stack_b, j))) \
		&& ft_find_index(stack_b, j))
		i = ft_lstsize(stack_b) - ft_find_index(stack_b, j);
	return (i);
}
